...
const Contact: React.FC = () => {
  ...
  return (
    <div>
      <section className=" md:mx-[5rem] my-[5rem] p-[1rem] flex gap-x-8 ">
        ...
        <div className="w-full md:w-1/2 lg:w-2/3 py-[5rem] px-6 ">
          <form action="">
            ...
            <div className="button flex justify-end mt-[0.5rem] ">
              <button className="bg-[#113167] text-white px-12 py-3 font-[500] rounded-lg ">
                Send Message
              </button>
            </div>
          </form>
